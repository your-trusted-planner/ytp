...
--> statement-breakpoint
INSERT INTO `__new_document_templates`("id", "name", "description", "category", "folder_id", "content", "variables", "requires_notary", "is_active", "order", "original_file_name", "file_extension", "created_at", "updated_at") SELECT "id", "name", "description", "category", "folder_id", "content", "variables", "requires_notary", "is_active", "order", "original_file_name", "file_extension", "created_at", "updated_at" FROM `document_templates`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "email", "password", "firebase_uid", "role", "first_name", "last_name", "phone", "avatar", "status", "created_at", "updated_at") SELECT "id", "email", "password", "firebase_uid", "role", "first_name", "last_name", "phone", "avatar", "status", "created_at", "updated_at" FROM `users`;--> statement-breakpoint
