  ...
  <div class="max-w-4xl mx-auto space-y-6">
    <div>
      <h1 class="text-2xl font-bold text-gray-900">
        Seed WYDAPT Documents
      </h1>
      <p class="text-gray-600 mt-1">
        Upload and import WYDAPT documents to create the journey template
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div class="space-y-3">
          <div>
            ...
            >
              ...
              <option value="Trust-Documents">
                Trust Documents
              </option>
              <option value="Wyoming-Private-Family-Trust-Documents">
                Wyoming Private Family Trust Documents
              </option>
              <option value="Non-Charitable-Specific-Purpose-Trust-Documents">
                Non Charitable Specific Purpose Trust Documents
              </option>
              <option value="Investment-Decisions">
                Investment Decisions
              </option>
              <option value="Contributions-to-Trust">
                Contributions to Trust
              </option>
              <option value="Distributions-From-Trust">
      ...
      >
        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-burgundy-600 mx-auto" />
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div
        v-if="seedResult && !seeding"
        class="space-y-4"
      >
        <div
          v-if="seedResult.success"
        ...
        <div
          v-if="seedResult.errors && seedResult.errors.length > 0"
          class="bg-yellow-50 border border-yellow-200 rounded p-4"
        >
          <h4 class="font-semibold text-yellow-900 mb-2">
            ⚠️ Errors ({{ seedResult.errors.length }}):
          </h4>
          <ul class="text-sm text-yellow-800 space-y-1 max-h-48 overflow-auto">
            <li
              v-for="(error, i) in seedResult.errors"
              :key="i"
            >
              {{ error }}
            </li>
        ...
        <div
          v-if="seedResult.log"
          class="bg-gray-50 border border-gray-200 rounded p-4"
        >
