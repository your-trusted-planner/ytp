  ...
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div>
      ...
      <p class="text-gray-600 mt-1">
        Upload a WealthCounsel XML export to import an estate plan
      </p>
    </div>
      ...
      <div class="flex items-center gap-4">
        ...
        >
          ...
          <ChevronRight
            ...
            class="w-5 h-5 mx-4 text-gray-300"
          />
        </div>
      </div>
    </div>
    ...
    >
      <div class="animate-spin w-8 h-8 border-2 border-burgundy-600 border-t-transparent rounded-full mx-auto mb-4" />
    ...
    <UiCard v-else-if="currentStep === 0">
      ...
      >
        ...
        <p class="text-xs text-gray-400 mt-4">
          Accepts .xml files from WealthCounsel export
        </p>
      </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div v-if="parsedData.trust?.isJoint !== undefined">
              ...
              <p class="font-medium text-green-900">
                {{ parsedData.trust.isJoint ? 'Joint Trust' : 'Individual Trust' }}
              </p>
            </div>
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <div class="grid grid-cols-3 gap-4">
            <div>
              ...
              <p
                v-if="parsedData.fiduciarySummary?.totalRoleAssignments"
            ...
            <div>
              <p class="text-2xl font-bold text-purple-900">
                {{ parsedData.beneficiaries?.length || 0 }}
              </p>
              <p class="text-sm text-purple-600">
                Beneficiaries
              </p>
          ...
          <div
            v-if="parsedData.fiduciarySummary?.roleTypes?.length"
    ...
    <UiCard v-if="currentStep === 2 && parsedData">
      ...
      <div class="mt-6">
        ...
        <ul class="space-y-2 text-sm text-gray-600">
          ...
          <li
            v-if="peopleToCreate === 0 && peopleToLink === 0 && extractedPeople.length > 0"
            class="flex items-center gap-2"
          >
            <CheckCircle class="w-4 h-4 text-green-500" />
          ...
          <li
            v-if="parsedData.beneficiaries?.length"
            class="flex items-center gap-2"
          >
            <CheckCircle class="w-4 h-4 text-green-500" />
    ...
    <UiCard v-if="currentStep === 3">
      <div class="text-center py-8">
        ...
        <div
          v-if="importResult"
          class="mt-6 bg-gray-50 rounded-lg p-4 max-w-sm mx-auto"
        >
          <div class="space-y-2 text-sm">
            ...
            <div
              v-if="importResult.peopleLinked > 0"
              class="flex justify-between"
            >
            ...
            <div
              v-if="importResult.clientsCreated > 0"
              class="flex justify-between"
            >
        ...
        <div class="mt-8 flex justify-center gap-4">
          ...
          <NuxtLink
            v-if="importedPlanId"
            :to="`/estate-plans/${importedPlanId}`"
          >
            <UiButton>
              View Estate Plan
            </UiButton>
