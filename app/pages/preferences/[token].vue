  ...
  <div class="min-h-screen bg-gray-50 flex flex-col items-center px-4 py-8 sm:py-16">
    <div class="w-full max-w-lg">
      ...
      <template v-else-if="data">
        ...
        <!-- Global unsubscribe -->
        <div
          v-if="data.consent.globalUnsubscribe"
          class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4"
        >
          <div class="flex items-center gap-2">
            <ShieldOff class="w-5 h-5 text-red-500 flex-shrink-0" />
            <p class="text-sm text-red-700 font-medium">
              You are unsubscribed from all marketing communications.
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm divide-y divide-gray-100">
          <div
            v-for="ch in data.consent.consents"
            :key="ch.channelId"
          ...
          <div
            v-if="data.consent.consents.length === 0"
