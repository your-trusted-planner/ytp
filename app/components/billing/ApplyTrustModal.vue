<template>
  <UiModal
    :model-value="true"
    title="Apply Trust Funds to Invoice"
    ...
    >
      ...
      >
        <p class="text-sm text-red-700">
          Amount exceeds available trust balance
        </p>
      </div>

      <div
        v-if="amountExceedsInvoice"
        class="bg-amber-50 border border-amber-200 rounded-lg p-3"
      >
        <p class="text-sm text-amber-700">
          Amount exceeds invoice balance due
        </p>
      </div>

      <!-- Result Preview -->
      <div
        v-if="amountDollars && !amountExceedsBalance && !amountExceedsInvoice"
      ...
      >
        ...
        <div class="space-y-2">
          <div class="flex justify-between text-sm">
            ...
            <span
              class="font-medium"
              :class="newInvoiceBalance === 0 ? 'text-green-600' : 'text-gray-900'"
            >
