<template>
  <div class="space-y-4">
    ...
    <template v-else-if="consent">
      ...
      <UiCard>
        <div class="flex items-center justify-between">
          <div>
            ...
            <p
              v-if="consent.globalUnsubscribe && consent.globalUnsubscribeSource"
      ...
      <UiCard
        v-if="consent.consents.length > 0"
        title="Channel Preferences"
      >
        <div class="divide-y divide-gray-200">
          <div
            v-for="ch in consent.consents"
            :key="ch.channelId"
    ...
    <UiModal
      ...
      title="Confirm Global Unsubscribe"
      size="sm"
    >
